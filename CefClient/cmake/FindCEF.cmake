...
set(_CEF_ROOT "")
if(PROJECT_ROOT AND IS_DIRECTORY "${PROJECT_ROOT}")
  set(_CEF_ROOT "${PROJECT_ROOT}")
  set(_CEF_ROOT_EXPLICIT 1)
else()
  set(_ENV_CEF_ROOT "")
  if(DEFINED ENV{PROJECT_ROOT})
    file(TO_CMAKE_PATH "$ENV{PROJECT_ROOT}" _ENV_CEF_ROOT)
  endif()
...
set(CEF_INCLUDE_DIR ${PROJECT_ROOT}/3rd/cef)

link_directories(
    ${PROJECT_ROOT}/3rd/cef/lib
    )

if(NOT DEFINED _CEF_ROOT_EXPLICIT)
  message(FATAL_ERROR "Must specify a PROJECT_ROOT value via CMake or environment variable.")
endif()

if(NOT IS_DIRECTORY "${_CEF_ROOT}/cmake")
  message(FATAL_ERROR "No CMake bootstrap found for CEF binary distribution at: ${PROJECT_ROOT}.")
endif()
